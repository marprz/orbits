...
TEST( TestMatrices, PolarTest1 )
{
    ...
    MatrixD W = polar( t );
    double eps = 0.005;
    Vector3 v1 = { 0.99999999999997, 0.000000000011734, 0.0000002540569133 };
    Vector3 v2 = {-0.00000000001207, 0.999999999999131, 0.0000013181841582 };
    Vector3 v3 = {-0.00000025405691,-0.000001318184158, 0.999999999999099  };
...
TEST( TestMatrices, RotationTest1 )
{
    ...
    Vector3 v1 = { -0.889486850514503, 0.456960767201945, 0 };
    Vector3 v2 = { -0.456960767201945, -0.889486850514503, 0 };
    Vector3 v3 = { 0, 0, 1 };
...
TEST( TestMatrices, RotationTest2 )
{
    ...
    Vector3 v1 = { -0.734183129027552, 0.678951495359803, 0 };
    Vector3 v2 = { -0.678951495359803, -0.734183129027552, 0 };
    Vector3 v3 = { 0, 0, 1 };
    MatrixD expG = { v1, v2, v3 };
...
TEST( TestMatrices, ConversionMatrixTest1 )
{
    ...
    double eps = 0.005;
    Vector3 v1 = {-0.890012675378, 0.455935507093, 0.000501038234 };
    Vector3 v2 = {-0.455935545703,-0.890012795690, 0.000040898181 };
    Vector3 v3 = { 0.000464577372,-0.000192041241, 0.999999873644 };
...
TEST( TestMatrices, ConversionMatrixTest2 )
{
    ...
    MatrixD M = conversionMatrix( t );
    double eps = 0.005;
    Vector3 v1 = {-0.735797525627, 0.677200803753, 0.001035701345 };
    Vector3 v2 = {-0.677201160082,-0.735797926542, 0.000008992792 };
    Vector3 v3 = { 0.000768156828,-0.000694761278, 0.999999463621 };
    MatrixD expM = { v1, v2, v3 };
    for( int i=0; i<3; ++i )
        for( int j=0; j<3; ++j )
        {
